...
/*
bcp d'exec. montrent que solution_choisie.c est la bonne, suite de compréhensions. passage mutex(s)=>sémaphores.
*/
...
int main(int argc, char** argv){
  ...
  */
  int err1=sem_init(&semaphore1,0,1);
  int err2=sem_init(&semaphore2,0,1);
  pthread_t t1;
  pthread_t t2;
  err1=pthread_create(&t1,NULL,producteur,NULL);
  err2=pthread_create(&t2,NULL,consommateur,NULL);
